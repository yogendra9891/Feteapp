...
/**
 * Methods supporting a list of Feteapp records.
 */
class FeteappModeleventfees extends JModelList
{
	...
	{   
		...
		$query->select(
			$this->getState(
				'list.select',
				'a.id, a.type, a.cost, a.published')
		);
		...
		$orderCol = $this->state->get('list.ordering', 'a.type');
