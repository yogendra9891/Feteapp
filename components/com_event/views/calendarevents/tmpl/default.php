...
?>
<form action="<?php echo JRoute::_('index.php?option=com_event&view=calendarevents'); ?>" method="post" name="adminForm" id="adminForm">
...
<!--			</td>-->
	...
	<div>
		...
		<input type="hidden" name="dateselected" value="<?php echo JRequest::getVar('dateselected');?>" />

		<?php echo JHtml::_('form.token'); ?>
	</div>
	<?php else: ?>
	<div class="noeventavailabel"><?php echo JText::_('COM_EVENT_NOEVENT_AVAILABLE'); ?>
	</div>
	<?php endif;?>
</form>